namespace Panuon.WPF.UI.Themes.Internal.Resources
{
    internal static class ConverterKeys
    {
        public const string ElementCornerRadiusConverter = nameof(ElementCornerRadiusConverter);
        public const string ElementFontFamilyConverter = nameof(ElementFontFamilyConverter);
        public const string ElementFontSizeConverter = nameof(ElementFontSizeConverter);
        public const string ElementFontWeightsConverter = nameof(ElementFontWeightsConverter);
